...
namespace ServerMonitorApplication
{
    ...
    public class MainWindowViewModel : ViewModelBase, INotifyPropertyChanged
    {
        ...
        /// </summary>
        public event PropertyChangedEventHandler mPropertyChanged = (sender, e) => { };
        ...
        public ViewModelBase CurrentViewModel
        {
            ...
            set { Set(ref mCurrentViewModel, value); }
        }
        ...
        {
            mPropertyChanged(this, new PropertyChangedEventArgs(name));
        }

        /// <summary>
        /// Set current view model to connection view model
        /// </summary>
        private void ShowConnectionView()
        {
            CurrentViewModel = mConnectionViewModel;
        }

        /// <summary>
        /// Set current view model to login view model
        /// </summary>
        ...
        {
            if (message.ViewModelType == typeof(ConnectionViewModel))
            {
                ShowConnectionView();
            }
